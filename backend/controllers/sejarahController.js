...
const tambahSejarah = (req, res) => {
  ...
  db.query(query, [isi], (err, result) => {
    ...
    console.log("Data sejarah berhasil disimpan:", result);
...
const getAllSejarah = (req, res) => {
  ...
  db.query(query, (err, result) => {
    ...
    console.log("Data sejarah berhasil didapatkan:", result);
...
const getSejarahById = (req, res) => {
  ...
  db.query(query, [id], (err, result) => {
    ...
    console.log("Data sejarah berhasil didapatkan:", result[0]);
...
const updateSejarah = (req, res) => {
  ...
  db.query(query, [isi, id], (err, result) => {
    ...
    console.log("Data sejarah berhasil diperbarui:", result);
    return res
      .status(200)
...
const deleteSejarah = (req, res) => {
  ...
  db.query(query, [id], (err, result) => {
    ...
    console.log("Data sejarah berhasil dihapus:", result);
