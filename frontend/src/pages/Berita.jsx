...
function Berita() {
  ...
  const fetchDataSejarah = () => {
    axios
      .get("http://localhost:3040/sejarah") // Ganti URL dengan endpoint yang benar di backend Anda
      .then((response) => {
        ...
        <ul className="list-unstyled components">
          ...
          <li className="dropdown">
            ...
            <ul className="collapse list-unstyled menu" id="pageSubmenu2">
              ...
              <li className="active">
                <a href="/berita" data-toggle="collapse" aria-expanded="false">
        ...
        <div style={{ margin: "20px" }}>
          <div className="mt-3">
            {sejarah.map((item, index) => (
              <Link to={`/sejarah/` + item.id} className="btn btn-success">
                Edit Sejarah
              </Link>
            ))}
